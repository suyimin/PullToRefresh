...
import com.xdroid.lib.ptr.loadmore.DefaultLoadMoreViewFooter;
import com.xdroid.lib.ptr.loadmore.GridViewHandler;
import com.xdroid.lib.ptr.loadmore.ILoadMoreViewFactory;
import com.xdroid.lib.ptr.loadmore.ILoadMoreViewFactory.ILoadMoreView;
import com.xdroid.lib.ptr.loadmore.ListViewHandler;
import com.xdroid.lib.ptr.loadmore.LoadMoreHandler;
import com.xdroid.lib.ptr.loadmore.OnLoadMoreListener;
import com.xdroid.lib.ptr.loadmore.OnScrollBottomListener;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray arr = context.obtainStyledAttributes(attrs, com.xdroid.lib.ptr.R.styleable.PtrFrameLayout, 0, 0);
        if (arr != null) {

            mHeaderId = arr.getResourceId(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_header, mHeaderId);
            mContainerId = arr.getResourceId(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_content, mContainerId);

            mPtrIndicator.setResistance(
                    arr.getFloat(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_resistance, mPtrIndicator.getResistance()));

            mDurationToClose = arr.getInt(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_duration_to_close, mDurationToClose);
            mDurationToCloseHeader = arr.getInt(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_duration_to_close_header, mDurationToCloseHeader);

            float ratio = mPtrIndicator.getRatioOfHeaderToHeightRefresh();
            ratio = arr.getFloat(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_ratio_of_header_height_to_refresh, ratio);
            mPtrIndicator.setRatioOfHeaderHeightToRefresh(ratio);

            mKeepHeaderWhenRefresh = arr.getBoolean(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_keep_header_when_refresh, mKeepHeaderWhenRefresh);

            mPullToRefresh = arr.getBoolean(com.xdroid.lib.ptr.R.styleable.PtrFrameLayout_ptr_pull_to_fresh, mPullToRefresh);
            arr.recycle();
        }
